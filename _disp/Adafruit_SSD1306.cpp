...
// #define SPI_// TRANSACTION_START spi->beginTransaction(spiSettings) ///< Pre-SPI
// #define SPI_// TRANSACTION_END spi->endTransaction()                ///< Post-SPI
// #else // SPI transactions likewise not present in older Arduino SPI lib
// #define SPI_// TRANSACTION_START ///< Dummy stand-in define
// #define SPI_// TRANSACTION_END   ///< keeps compiler happy
// #endif
...
*/
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h, I2C * wire_p,
    int8_t rst_pin, uint32_t clkDuring,
    /*uint32_t clkAfter*/ uint8_t rot)
...
//                 static
//                 const uint8_t PROGMEM premask[8] = {
//                     0x00,
//                     0x80,
//                     0xC0,
//                     0xE0,
...
//                     // improvement in fill* functions
//                     static
//                     const uint8_t PROGMEM postmask[8] = {
//                         0x00,
//                         0x01,
//                         0x03,
//                         0x07,
...
//     // TRANSACTION_START
//     static
//     const uint8_t PROGMEM scrollList1a[] = {
...
//     static
//     const uint8_t PROGMEM scrollList1b[] = {
//         0X00,
//         0XFF,
...
//     // TRANSACTION_START
//     static
//     const uint8_t PROGMEM scrollList2a[] = {
...
//     // TRANSACTION_START
//     static
//     const uint8_t PROGMEM scrollList3a[] = {
...
//     static
//     const uint8_t PROGMEM scrollList3b[] = {
...
//     ssd1306_command1(stop);
//     static
//     const uint8_t PROGMEM scrollList3c[] = {
//         0X01,
//         SSD1306_ACTIVATE_SCROLL
//     };
...
//     // TRANSACTION_START
//     static
//     const uint8_t PROGMEM scrollList4a[] = {
//         SSD1306_SET_VERTICAL_SCROLL_AREA,
//         0X00
//     };
...
//     ssd1306_command1(HEIGHT);
//     static
//     const uint8_t PROGMEM scrollList4b[] = {
...
//     ssd1306_command1(stop);
//     static
//     const uint8_t PROGMEM scrollList4c[] = {
//         0X01,
//         SSD1306_ACTIVATE_SCROLL
//     };
